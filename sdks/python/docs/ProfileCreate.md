...
**is_pre_network_tokenization_enabled** | **bool** | Indicates if pre network tokenization is enabled or not | [optional] 
...
**dispute_polling_interval** | **int** | Time interval (in hours) for polling the connector to check dispute statuses | [optional] 
