...
**step_up_possible** | **bool** | indicates if step_up retry is possible **Deprecated**: This field is now included as part of &#x60;feature_data&#x60; under the &#x60;Retry&#x60; variant. | 
...
**clear_pan_possible** | **bool** | indicates if retry with pan is possible **Deprecated**: This field is now included as part of &#x60;feature_data&#x60; under the &#x60;Retry&#x60; variant. | 
