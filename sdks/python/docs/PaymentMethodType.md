...
* `BREADPAY` (value: `'breadpay'`)

* `BRI_VA` (value: `'bri_va'`)

* `BHN_CARD_NETWORK` (value: `'bhn_card_network'`)
...
* `INSTANT_BANK_TRANSFER_FINLAND` (value: `'instant_bank_transfer_finland'`)

* `INSTANT_BANK_TRANSFER_POLAND` (value: `'instant_bank_transfer_poland'`)

* `REVOLUT_PAY` (value: `'revolut_pay'`)

* `INDONESIAN_BANK_TRANSFER` (value: `'indonesian_bank_transfer'`)
