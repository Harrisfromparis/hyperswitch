...
------------- | ------------- | -------------
[**create_a_merchant_connector**](MerchantConnectorAccountApi.md#create_a_merchant_connector) | **POST** /account/{account_id}/connectors | Merchant Connector - Create
[**delete_a_merchant_connector**](MerchantConnectorAccountApi.md#delete_a_merchant_connector) | **DELETE** /account/{account_id}/connectors/{merchant_connector_id} | Merchant Connector - Delete
[**list_all_merchant_connectors**](MerchantConnectorAccountApi.md#list_all_merchant_connectors) | **GET** /account/{account_id}/connectors | Merchant Connector - List
[**retrieve_a_merchant_connector**](MerchantConnectorAccountApi.md#retrieve_a_merchant_connector) | **GET** /account/{account_id}/connectors/{merchant_connector_id} | Merchant Connector - Retrieve
[**update_a_merchant_connector**](MerchantConnectorAccountApi.md#update_a_merchant_connector) | **POST** /account/{account_id}/connectors/{merchant_connector_id} | Merchant Connector - Update


# **create_a_merchant_connector**
> MerchantConnectorResponse create_a_merchant_connector(account_id, merchant_connector_create)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    try:
        # Merchant Connector - Create
        api_response = api_instance.create_a_merchant_connector(account_id, merchant_connector_create)
...
> MerchantConnectorDeleteResponse delete_a_merchant_connector(account_id, merchant_connector_id)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    api_instance = hyperswitch.MerchantConnectorAccountApi(api_client)
    account_id = 'account_id_example' # str | The unique identifier for the merchant account
    merchant_connector_id = 'merchant_connector_id_example' # str | The unique identifier for the Merchant Connector

    try:
        # Merchant Connector - Delete
        api_response = api_instance.delete_a_merchant_connector(account_id, merchant_connector_id)
...
------------- | ------------- | ------------- | -------------
 **account_id** | **str**| The unique identifier for the merchant account | 
 **merchant_connector_id** | **str**| The unique identifier for the Merchant Connector | 
...
> MerchantConnectorResponse retrieve_a_merchant_connector(account_id, merchant_connector_id)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    try:
        # Merchant Connector - Retrieve
        api_response = api_instance.retrieve_a_merchant_connector(account_id, merchant_connector_id)
...
> MerchantConnectorResponse update_a_merchant_connector(account_id, merchant_connector_id, merchant_connector_update)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    try:
        # Merchant Connector - Update
        api_response = api_instance.update_a_merchant_connector(account_id, merchant_connector_id, merchant_connector_update)
