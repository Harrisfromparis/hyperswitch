...
**is_setup_mandate_flow** | **bool** | Boolean to control payment button text for setup mandate calls | [optional] 
**color_icon_card_cvc_error** | **str** | Hex color for the CVC icon during error state | [optional] 
