...
**category** | [**HyperswitchConnectorCategory**](HyperswitchConnectorCategory.md) |  | 
**integration_status** | [**ConnectorIntegrationStatus**](ConnectorIntegrationStatus.md) |  | 
**supported_payment_methods** | [**List[SupportedPaymentMethod]**](SupportedPaymentMethod.md) | The list of payment methods supported by the connector | [optional] 
