...
------------ | ------------- | ------------- | -------------
**merchant_order_reference_id** | **str** | Your unique identifier for this payout or order. This ID helps you reconcile payouts on your system. If provided, it is passed to the connector if supported. | [optional] 
...
**routing** | [**StaticRoutingAlgorithm**](StaticRoutingAlgorithm.md) |  | [optional] 
