...
------------ | ------------- | ------------- | -------------
**city** | **str** | The city, district, suburb, town, or village of the address. | [optional] 
**country** | [**CountryAlpha2**](CountryAlpha2.md) |  | [optional] 
**line1** | **str** | The first line of the street address or P.O. Box. | [optional] 
**line2** | **str** | The second line of the street address or P.O. Box (e.g., apartment, suite, unit, or building). | [optional] 
**line3** | **str** | The third line of the street address, if applicable. | [optional] 
...
**origin_zip** | **str** | The zip/postal code of the origin | [optional] 
