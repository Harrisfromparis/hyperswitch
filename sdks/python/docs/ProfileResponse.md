...
**payout_routing_algorithm** | [**StaticRoutingAlgorithm**](StaticRoutingAlgorithm.md) |  | [optional] 
...
**is_pre_network_tokenization_enabled** | **bool** | Indicates if pre network tokenization is enabled or not | [default to False]
**acquirer_configs** | [**List[ProfileAcquirerResponse]**](ProfileAcquirerResponse.md) | Acquirer configs | [optional] 
...
**merchant_country_code** | **str** | A wrapper type for merchant country codes that provides validation and conversion functionality.  This type stores a country code as a string and provides methods to validate it and convert it to a &#x60;Country&#x60; enum variant. | [optional] 
**dispute_polling_interval** | **int** |  | [optional] 
