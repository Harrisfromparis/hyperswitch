...
**payment_statuses_enabled** | [**List[IntentStatus]**](IntentStatus.md) | List of payment statuses that triggers a webhook for payment intents | 
**refund_statuses_enabled** | [**List[IntentStatus]**](IntentStatus.md) | List of refund statuses that triggers a webhook for refunds | 
**payout_statuses_enabled** | [**List[PayoutStatus]**](PayoutStatus.md) | List of payout statuses that triggers a webhook for payouts | [optional] 
