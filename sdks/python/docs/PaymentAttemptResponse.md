...
------------ | ------------- | ------------- | -------------
**attempt_id** | **str** | A unique identifier for this specific payment attempt. | 
...
**connector** | **str** | The name of the payment connector (e.g., &#39;stripe&#39;, &#39;adyen&#39;) used for this attempt. | [optional] 
**error_message** | **str** | A human-readable message from the connector explaining the error, if one occurred during this payment attempt. | [optional] 
...
**mandate_id** | **str** | If this payment attempt is associated with a mandate (e.g., for a recurring or subsequent payment), this field will contain the ID of that mandate. | [optional] 
**error_code** | **str** | The error code returned by the connector if this payment attempt failed. This code is specific to the connector. | [optional] 
**payment_token** | **str** | If a tokenized (saved) payment method was used for this attempt, this field contains the payment token representing that payment method. | [optional] 
...
**reference_id** | **str** | The connector&#39;s own reference or transaction ID for this specific payment attempt. Useful for reconciliation with the connector. | [optional] 
