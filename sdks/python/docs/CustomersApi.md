...
> List[CustomerResponse] list_all_customers_for_a_merchant(offset=offset, limit=limit)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    try:
        # Customers - List
        api_response = api_instance.list_all_customers_for_a_merchant(offset=offset, limit=limit)
