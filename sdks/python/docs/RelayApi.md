...
> RelayResponse retrieve_a_relay_details(relay_id, x_profile_id)
...
with hyperswitch.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hyperswitch.RelayApi(api_client)
    relay_id = 'relay_id_example' # str | The unique identifier for the Relay
    x_profile_id = 'x_profile_id_example' # str | Profile ID for authentication

    try:
        # Relay - Retrieve
        api_response = api_instance.retrieve_a_relay_details(relay_id, x_profile_id)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **relay_id** | **str**| The unique identifier for the Relay | 
 **x_profile_id** | **str**| Profile ID for authentication | 
