...
* `PAYMENT_CANCELLED_POST_CAPTURE` (value: `'payment_cancelled_post_capture'`)

* `PAYMENT_AUTHORIZED` (value: `'payment_authorized'`)

* `PAYMENT_PARTIALLY_AUTHORIZED` (value: `'payment_partially_authorized'`)

* `PAYMENT_CAPTURED` (value: `'payment_captured'`)

* `PAYMENT_EXPIRED` (value: `'payment_expired'`)
