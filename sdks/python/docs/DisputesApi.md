...
# **retrieve_a_dispute**
> DisputeResponse retrieve_a_dispute(dispute_id, force_sync=force_sync)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    force_sync = True # bool | Decider to enable or disable the connector call for dispute retrieve request (optional)

    try:
        # Disputes - Retrieve Dispute
        api_response = api_instance.retrieve_a_dispute(dispute_id, force_sync=force_sync)
 ...
 **force_sync** | **bool**| Decider to enable or disable the connector call for dispute retrieve request | [optional] 
