...
------------- | ------------- | -------------
[**list_mandates_for_a_customer**](MandatesApi.md#list_mandates_for_a_customer) | **GET** /customers/{customer_id}/mandates | Mandates - Customer Mandates List
...
> List[MandateResponse] list_mandates_for_a_customer(customer_id)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    try:
        # Mandates - Customer Mandates List
        api_response = api_instance.list_mandates_for_a_customer(customer_id)
