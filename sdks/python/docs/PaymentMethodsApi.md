...
[**list_customer_payment_methods_via_client_secret**](PaymentMethodsApi.md#list_customer_payment_methods_via_client_secret) | **GET** /customers/payment_methods | List customer saved payment methods for a Payment
...
[**set_the_payment_method_as_default**](PaymentMethodsApi.md#set_the_payment_method_as_default) | **POST** /{customer_id}/payment_methods/{payment_method_id}/default | Payment Method - Set Default Payment Method for Customer
...
> CustomerPaymentMethodsListResponse list_all_payment_methods_for_a_customer(customer_id, client_secret=client_secret, accepted_countries=accepted_countries, accepted_currencies=accepted_currencies, amount=amount, recurring_enabled=recurring_enabled, installment_payment_enabled=installment_payment_enabled, limit=limit, card_networks=card_networks)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    accepted_countries = [hyperswitch.CountryAlpha2()] # List[CountryAlpha2] | The two-letter ISO currency code (optional)
    accepted_currencies = [hyperswitch.Currency()] # List[Currency] | The three-letter ISO currency code (optional)
    amount = 56 # int | The amount accepted for processing by the particular payment method. (optional)
    recurring_enabled = True # bool | Indicates whether the payment method is eligible for recurring payments (optional)
    installment_payment_enabled = True # bool | Indicates whether the payment method is eligible for installment payments (optional)
    limit = 56 # int | Indicates the limit of last used payment methods (optional)
    card_networks = [hyperswitch.CardNetwork()] # List[CardNetwork] | Indicates whether the payment method is eligible for card netwotks (optional)

    try:
        # List payment methods for a Customer
        api_response = api_instance.list_all_payment_methods_for_a_customer(customer_id, client_secret=client_secret, accepted_countries=accepted_countries, accepted_currencies=accepted_currencies, amount=amount, recurring_enabled=recurring_enabled, installment_payment_enabled=installment_payment_enabled, limit=limit, card_networks=card_networks)
 ...
 **accepted_countries** | [**List[CountryAlpha2]**](CountryAlpha2.md)| The two-letter ISO currency code | [optional] 
 **accepted_currencies** | [**List[Currency]**](Currency.md)| The three-letter ISO currency code | [optional] 
 **amount** | **int**| The amount accepted for processing by the particular payment method. | [optional] 
 **recurring_enabled** | **bool**| Indicates whether the payment method is eligible for recurring payments | [optional] 
 **installment_payment_enabled** | **bool**| Indicates whether the payment method is eligible for installment payments | [optional] 
 **limit** | **int**| Indicates the limit of last used payment methods | [optional] 
 **card_networks** | [**List[CardNetwork]**](CardNetwork.md)| Indicates whether the payment method is eligible for card netwotks | [optional] 
...
> PaymentMethodListResponse list_all_payment_methods_for_a_merchant(client_secret=client_secret, accepted_countries=accepted_countries, accepted_currencies=accepted_currencies, amount=amount, recurring_enabled=recurring_enabled, installment_payment_enabled=installment_payment_enabled, limit=limit, card_networks=card_networks)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    try:
        # List payment methods for a Merchant
        api_response = api_instance.list_all_payment_methods_for_a_merchant(client_secret=client_secret, accepted_countries=accepted_countries, accepted_currencies=accepted_currencies, amount=amount, recurring_enabled=recurring_enabled, installment_payment_enabled=installment_payment_enabled, limit=limit, card_networks=card_networks)
...
# **list_customer_payment_methods_via_client_secret**
> CustomerPaymentMethodsListResponse list_customer_payment_methods_via_client_secret(client_secret=client_secret, accepted_countries=accepted_countries, accepted_currencies=accepted_currencies, amount=amount, recurring_enabled=recurring_enabled, installment_payment_enabled=installment_payment_enabled, limit=limit, card_networks=card_networks)
...
with hyperswitch.ApiClient(configuration) as api_client:
    ...
    try:
        # List customer saved payment methods for a Payment
        api_response = api_instance.list_customer_payment_methods_via_client_secret(client_secret=client_secret, accepted_countries=accepted_countries, accepted_currencies=accepted_currencies, amount=amount, recurring_enabled=recurring_enabled, installment_payment_enabled=installment_payment_enabled, limit=limit, card_networks=card_networks)
        print("The response of PaymentMethodsApi->list_customer_payment_methods_via_client_secret:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentMethodsApi->list_customer_payment_methods_via_client_secret: %s\n" % e)
```
