...
**recurring_enabled** | **bool** | Indicates whether the payment method supports recurring payments. Optional. | [optional] 
**installment_payment_enabled** | **bool** | Indicates whether the payment method is eligible for installment payments (e.g., EMI, BNPL). Optional. | [optional] 
