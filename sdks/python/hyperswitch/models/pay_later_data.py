...
PAYLATERDATA_ONE_OF_SCHEMAS = ["PayLaterDataOneOf", "PayLaterDataOneOf1", "PayLaterDataOneOf2", "PayLaterDataOneOf3", "PayLaterDataOneOf4", "PayLaterDataOneOf5", "PayLaterDataOneOf6", "PayLaterDataOneOf7", "PayLaterDataOneOf8", "PayLaterDataOneOf9"]
...
class PayLaterData(BaseModel):
    ...
    # data type: PayLaterDataOneOf8
    oneof_schema_9_validator: Optional[PayLaterDataOneOf8] = None
    # data type: PayLaterDataOneOf9
    oneof_schema_10_validator: Optional[PayLaterDataOneOf9] = None
    actual_instance: Optional[Union[PayLaterDataOneOf, PayLaterDataOneOf1, PayLaterDataOneOf2, PayLaterDataOneOf3, PayLaterDataOneOf4, PayLaterDataOneOf5, PayLaterDataOneOf6, PayLaterDataOneOf7, PayLaterDataOneOf8, PayLaterDataOneOf9]] = None
    one_of_schemas: Set[str] = { "PayLaterDataOneOf", "PayLaterDataOneOf1", "PayLaterDataOneOf2", "PayLaterDataOneOf3", "PayLaterDataOneOf4", "PayLaterDataOneOf5", "PayLaterDataOneOf6", "PayLaterDataOneOf7", "PayLaterDataOneOf8", "PayLaterDataOneOf9" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, PayLaterDataOneOf7):
            ...
            match += 1
        # validate data type: PayLaterDataOneOf8
        if not isinstance(v, PayLaterDataOneOf8):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PayLaterDataOneOf8`")
        else:
            match += 1
        # validate data type: PayLaterDataOneOf9
        if not isinstance(v, PayLaterDataOneOf9):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PayLaterDataOneOf9`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in PayLaterData with oneOf schemas: PayLaterDataOneOf, PayLaterDataOneOf1, PayLaterDataOneOf2, PayLaterDataOneOf3, PayLaterDataOneOf4, PayLaterDataOneOf5, PayLaterDataOneOf6, PayLaterDataOneOf7, PayLaterDataOneOf8, PayLaterDataOneOf9. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in PayLaterData with oneOf schemas: PayLaterDataOneOf, PayLaterDataOneOf1, PayLaterDataOneOf2, PayLaterDataOneOf3, PayLaterDataOneOf4, PayLaterDataOneOf5, PayLaterDataOneOf6, PayLaterDataOneOf7, PayLaterDataOneOf8, PayLaterDataOneOf9. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into PayLaterDataOneOf8
        try:
            instance.actual_instance = PayLaterDataOneOf8.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into PayLaterDataOneOf9
        try:
            instance.actual_instance = PayLaterDataOneOf9.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into PayLaterData with oneOf schemas: PayLaterDataOneOf, PayLaterDataOneOf1, PayLaterDataOneOf2, PayLaterDataOneOf3, PayLaterDataOneOf4, PayLaterDataOneOf5, PayLaterDataOneOf6, PayLaterDataOneOf7, PayLaterDataOneOf8, PayLaterDataOneOf9. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], PayLaterDataOneOf, PayLaterDataOneOf1, PayLaterDataOneOf2, PayLaterDataOneOf3, PayLaterDataOneOf4, PayLaterDataOneOf5, PayLaterDataOneOf6, PayLaterDataOneOf7, PayLaterDataOneOf8, PayLaterDataOneOf9]]:
