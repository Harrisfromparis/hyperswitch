...
class PayoutsCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["merchant_order_reference_id", "amount", "currency", "routing", "connector", "confirm", "payout_type", "payout_method_data", "billing", "auto_fulfill", "customer_id", "customer", "return_url", "business_country", "business_label", "description", "entity_type", "recurring", "metadata", "payout_token", "profile_id", "priority", "payout_link", "payout_link_config", "session_expiry", "email", "name", "phone", "phone_country_code", "payout_method_id"]
