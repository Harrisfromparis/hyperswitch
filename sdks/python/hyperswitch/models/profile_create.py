...
class ProfileCreate(BaseModel):
    ...
    is_pre_network_tokenization_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if pre network tokenization is enabled or not")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_pre_network_tokenization_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.is_pre_network_tokenization_enabled is None and "is_pre_network_tokenization_enabled" in self.model_fields_set:
            _dict['is_pre_network_tokenization_enabled'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_pre_network_tokenization_enabled": obj.get("is_pre_network_tokenization_enabled"),
