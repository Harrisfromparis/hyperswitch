...
class PayoutUpdateRequest(BaseModel):
    ...
    PayoutUpdateRequest
    """ # noqa: E501
    merchant_order_reference_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Your unique identifier for this payout or order. This ID helps you reconcile payouts on your system. If provided, it is passed to the connector if supported.")
    ...
    routing: Optional[StaticRoutingAlgorithm] = None
    ...
    __properties: ClassVar[List[str]] = ["merchant_order_reference_id", "amount", "currency", "routing", "connector", "confirm", "payout_type", "payout_method_data", "billing", "auto_fulfill", "customer_id", "customer", "client_secret", "return_url", "business_country", "business_label", "description", "entity_type", "recurring", "metadata", "payout_token", "profile_id", "priority", "payout_link", "payout_link_config", "session_expiry", "email", "name", "phone", "phone_country_code", "payout_method_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "routing": StaticRoutingAlgorithm.from_dict(obj["routing"]) if obj.get("routing") is not None else None,
