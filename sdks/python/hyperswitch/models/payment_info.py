...
class PaymentInfo(BaseModel):
    ...
    card_isin: Optional[StrictStr] = Field(default=None, alias="cardIsin")
    __properties: ClassVar[List[str]] = ["paymentId", "amount", "currency", "paymentType", "metadata", "paymentMethodType", "paymentMethod", "cardIsin"]
