...
class PayoutCreateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payout_id", "merchant_id", "merchant_order_reference_id", "amount", "currency", "connector", "payout_type", "payout_method_data", "billing", "auto_fulfill", "customer_id", "customer", "client_secret", "return_url", "business_country", "business_label", "description", "entity_type", "recurring", "metadata", "merchant_connector_id", "status", "error_message", "error_code", "profile_id", "created", "connector_transaction_id", "priority", "attempts", "payout_link", "email", "name", "phone", "phone_country_code", "unified_code", "unified_message", "payout_method_id"]
