...
class AmazonPayWalletData(BaseModel):
    """
    AmazonPayWalletData
    """ # noqa: E501
    checkout_session_id: StrictStr = Field(description="Checkout Session identifier")
    __properties: ClassVar[List[str]] = ["checkout_session_id"]
