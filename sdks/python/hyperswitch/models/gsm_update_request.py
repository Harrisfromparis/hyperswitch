...
class GsmUpdateRequest(BaseModel):
    ...
    step_up_possible: Optional[StrictBool] = Field(default=None, description="indicates if step_up retry is possible **Deprecated**: This field is now included as part of `feature_data` under the `Retry` variant.")
    ...
    clear_pan_possible: Optional[StrictBool] = Field(default=None, description="indicates if retry with pan is possible **Deprecated**: This field is now included as part of `feature_data` under the `Retry` variant.")
    feature: Optional[GsmFeature] = None
    feature_data: Optional[GsmFeatureData] = None
    __properties: ClassVar[List[str]] = ["connector", "flow", "sub_flow", "code", "message", "status", "router_error", "decision", "step_up_possible", "unified_code", "unified_message", "error_category", "clear_pan_possible", "feature", "feature_data"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of feature_data
        if self.feature_data:
            _dict['feature_data'] = self.feature_data.to_dict()
        ...
        # set to None if feature_data (nullable) is None
        # and model_fields_set contains the field
        if self.feature_data is None and "feature_data" in self.model_fields_set:
            _dict['feature_data'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feature_data": GsmFeatureData.from_dict(obj["feature_data"]) if obj.get("feature_data") is not None else None
        })
        return _obj
