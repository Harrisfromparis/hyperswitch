...
class PaymentsResponse(BaseModel):
    ...
    amount_capturable: Annotated[int, Field(strict=True, ge=100)] = Field(description="The amount (in minor units) that can still be captured for this payment. This is relevant when `capture_method` is `manual`. Once fully captured, or if `capture_method` is `automatic` and payment succeeded, this will be 0.")
    amount_received: Optional[StrictInt] = Field(default=None, description="The total amount (in minor units) that has been captured for this payment. For `fauxpay` sandbox connector, this might reflect the authorized amount if `status` is `succeeded` even if `capture_method` was `manual`.")
    connector: Optional[StrictStr] = Field(default=None, description="The name of the payment connector (e.g., 'stripe', 'adyen') that processed or is processing this payment.")
    client_secret: Optional[StrictStr] = Field(default=None, description="A secret token unique to this payment intent. It is primarily used by client-side applications (e.g., Hyperswitch SDKs) to authenticate actions like confirming the payment or handling next actions. This secret should be handled carefully and not exposed publicly beyond its intended client-side use.")
    created: Optional[datetime] = Field(default=None, description="Timestamp indicating when this payment intent was created, in ISO 8601 format.")
    currency: Currency
    ...
    description: Optional[StrictStr] = Field(default=None, description="An arbitrary string providing a description for the payment, often useful for display or internal record-keeping.")
    refunds: Optional[List[RefundResponse]] = Field(default=None, description="An array of refund objects associated with this payment. Empty or null if no refunds have been processed.")
    ...
    cancellation_reason: Optional[StrictStr] = Field(default=None, description="If the payment intent was cancelled, this field provides a textual reason for the cancellation (e.g., \"requested_by_customer\", \"abandoned\").")
    error_code: Optional[StrictStr] = Field(default=None, description="The connector-specific error code from the last failed payment attempt associated with this payment intent.")
    error_message: Optional[StrictStr] = Field(default=None, description="A human-readable error message from the last failed payment attempt associated with this payment intent.")
    ...
    connector_label: Optional[StrictStr] = Field(default=None, description="A label identifying the specific merchant connector account (MCA) used for this payment. This often combines the connector name, business country, and a custom label (e.g., \"stripe_US_primary\").")
    business_country: Optional[CountryAlpha2] = None
    business_label: Optional[StrictStr] = Field(default=None, description="The label identifying the specific business unit or profile under which this payment was processed by the merchant.")
    business_sub_label: Optional[StrictStr] = Field(default=None, description="An optional sub-label for further categorization of the business unit or profile used for this payment.")
    ...
    payment_method_id: Optional[StrictStr] = Field(default=None, description="A unique identifier for the payment method used in this payment. If the payment method was saved or tokenized, this ID can be used to reference it for future transactions or recurring payments.")
    network_transaction_id: Optional[StrictStr] = Field(default=None, description="The network transaction ID is a unique identifier for the transaction as recognized by the payment network (e.g., Visa, Mastercard), this ID can be used to reference it for future transactions or recurring payments.")
    ...
    whole_connector_response: Optional[StrictStr] = Field(default=None, description="Contains whole connector response")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if network_transaction_id (nullable) is None
        # and model_fields_set contains the field
        if self.network_transaction_id is None and "network_transaction_id" in self.model_fields_set:
            _dict['network_transaction_id'] = None
        ...
        # set to None if whole_connector_response (nullable) is None
        # and model_fields_set contains the field
        if self.whole_connector_response is None and "whole_connector_response" in self.model_fields_set:
            _dict['whole_connector_response'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "whole_connector_response": obj.get("whole_connector_response"),
