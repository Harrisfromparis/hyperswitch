...
class AdyenConnectorMetadata(BaseModel):
    """
    AdyenConnectorMetadata
    """ # noqa: E501
    testing: AdyenTestingData
    __properties: ClassVar[List[str]] = ["testing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testing": AdyenTestingData.from_dict(obj["testing"]) if obj.get("testing") is not None else None
        })
        return _obj
