...
class MerchantAccountCreate(BaseModel):
    ...
    """ # noqa: E501
    merchant_id: Annotated[str, Field(min_length=1, strict=True, max_length=64)] = Field(description="The identifier for the Merchant Account")
    ...
    publishable_key: Optional[StrictStr] = Field(default=None, description="API key that will be used for client side API access. A publishable key has to be always paired with a `client_secret`. A `client_secret` can be obtained by creating a payment with `confirm` set to false")
    ...
    primary_business_details: Optional[PrimaryBusinessDetails] = None
    ...
    organization_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="The id of the organization to which the merchant belongs to, if not passed an organization is created")
    pm_collect_link_config: Optional[BusinessCollectLinkConfig] = None
    product_type: Optional[MerchantProductType] = None
    merchant_account_type: Optional[MerchantAccountRequestType] = None
    __properties: ClassVar[List[str]] = ["merchant_id", "merchant_name", "merchant_details", "return_url", "webhook_details", "payout_routing_algorithm", "sub_merchants_enabled", "parent_merchant_id", "enable_payment_response_hash", "payment_response_hash_key", "redirect_to_merchant_with_http_post", "metadata", "publishable_key", "locker_id", "primary_business_details", "frm_routing_algorithm", "organization_id", "pm_collect_link_config", "product_type", "merchant_account_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of primary_business_details
        if self.primary_business_details:
            _dict['primary_business_details'] = self.primary_business_details.to_dict()
        ...
        # set to None if merchant_account_type (nullable) is None
        # and model_fields_set contains the field
        if self.merchant_account_type is None and "merchant_account_type" in self.model_fields_set:
            _dict['merchant_account_type'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "primary_business_details": PrimaryBusinessDetails.from_dict(obj["primary_business_details"]) if obj.get("primary_business_details") is not None else None,
