...
class ProfileResponse(BaseModel):
    ...
    payout_routing_algorithm: Optional[StaticRoutingAlgorithm] = None
    ...
    is_clear_pan_retries_enabled: StrictBool = Field(description="Indicates if clear pan retries is enabled or not.")
    force_3ds_challenge: StrictBool = Field(description="Indicates if 3ds challenge is forced")
    ...
    is_pre_network_tokenization_enabled: StrictBool = Field(description="Indicates if pre network tokenization is enabled or not")
    acquirer_configs: Optional[List[ProfileAcquirerResponse]] = Field(default=None, description="Acquirer configs")
    ...
    merchant_category_code: Optional[MerchantCategoryCode] = None
    merchant_country_code: Optional[StrictStr] = Field(default=None, description="A wrapper type for merchant country codes that provides validation and conversion functionality.  This type stores a country code as a string and provides methods to validate it and convert it to a `Country` enum variant.")
    dispute_polling_interval: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    __properties: ClassVar[List[str]] = ["merchant_id", "profile_id", "profile_name", "return_url", "enable_payment_response_hash", "payment_response_hash_key", "redirect_to_merchant_with_http_post", "webhook_details", "metadata", "routing_algorithm", "intent_fulfillment_time", "frm_routing_algorithm", "payout_routing_algorithm", "applepay_verified_domains", "session_expiry", "payment_link_config", "authentication_connector_details", "use_billing_as_payment_method_billing", "extended_card_info_config", "collect_shipping_details_from_wallet_connector", "collect_billing_details_from_wallet_connector", "always_collect_shipping_details_from_wallet_connector", "always_collect_billing_details_from_wallet_connector", "is_connector_agnostic_mit_enabled", "payout_link_config", "outgoing_webhook_custom_http_headers", "tax_connector_id", "is_tax_connector_enabled", "is_network_tokenization_enabled", "is_auto_retries_enabled", "max_auto_retries_enabled", "always_request_extended_authorization", "is_click_to_pay_enabled", "authentication_product_ids", "card_testing_guard_config", "is_clear_pan_retries_enabled", "force_3ds_challenge", "is_debit_routing_enabled", "merchant_business_country", "is_pre_network_tokenization_enabled", "acquirer_configs", "is_iframe_redirection_enabled", "merchant_category_code", "merchant_country_code", "dispute_polling_interval"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in acquirer_configs (list)
        _items = []
        if self.acquirer_configs:
            for _item_acquirer_configs in self.acquirer_configs:
                if _item_acquirer_configs:
                    _items.append(_item_acquirer_configs.to_dict())
            _dict['acquirer_configs'] = _items
        ...
        # set to None if acquirer_configs (nullable) is None
        # and model_fields_set contains the field
        if self.acquirer_configs is None and "acquirer_configs" in self.model_fields_set:
            _dict['acquirer_configs'] = None
        ...
        # and model_fields_set contains the field
        if self.merchant_category_code is None and "merchant_category_code" in self.model_fields_set:
            _dict['merchant_category_code'] = None

        # set to None if merchant_country_code (nullable) is None
        # and model_fields_set contains the field
        if self.merchant_country_code is None and "merchant_country_code" in self.model_fields_set:
            _dict['merchant_country_code'] = None

        # set to None if dispute_polling_interval (nullable) is None
        # and model_fields_set contains the field
        if self.dispute_polling_interval is None and "dispute_polling_interval" in self.model_fields_set:
            _dict['dispute_polling_interval'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payout_routing_algorithm": StaticRoutingAlgorithm.from_dict(obj["payout_routing_algorithm"]) if obj.get("payout_routing_algorithm") is not None else None,
            ...
            "is_pre_network_tokenization_enabled": obj.get("is_pre_network_tokenization_enabled") if obj.get("is_pre_network_tokenization_enabled") is not None else False,
            "acquirer_configs": [ProfileAcquirerResponse.from_dict(_item) for _item in obj["acquirer_configs"]] if obj.get("acquirer_configs") is not None else None,
            ...
            "dispute_polling_interval": obj.get("dispute_polling_interval")
        })
        return _obj
