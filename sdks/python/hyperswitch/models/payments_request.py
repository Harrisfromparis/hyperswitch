...
from hyperswitch.models.tax_status import TaxStatus
...
class PaymentsRequest(BaseModel):
    ...
    PaymentsRequest
    """ # noqa: E501
    amount: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The primary amount for the payment, provided in the lowest denomination of the specified currency (e.g., 6540 for $65.40 USD). This field is mandatory for creating a payment.")
    order_tax_amount: Optional[StrictInt] = Field(default=None, description="Total tax amount applicable to the order, in the lowest denomination of the currency.")
    currency: Optional[Currency] = None
    amount_to_capture: Optional[StrictInt] = Field(default=None, description="The amount to be captured from the user's payment method, in the lowest denomination. If not provided, and `capture_method` is `automatic`, the full payment `amount` will be captured. If `capture_method` is `manual`, this can be specified in the `/capture` call. Must be less than or equal to the authorized amount.")
    ...
    confirm: Optional[StrictBool] = Field(default=False, description="If set to `true`, Hyperswitch attempts to confirm and authorize the payment immediately after creation, provided sufficient payment method details are included. If `false` or omitted (default is `false`), the payment is created with a status such as `requires_payment_method` or `requires_confirmation`, and a separate `POST /payments/{payment_id}/confirm` call is necessary to proceed with authorization.")
    ...
    email: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The customer's email address. This field will be deprecated soon, use the customer object instead")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The customer's name. This field will be deprecated soon, use the customer object instead.")
    phone: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The customer's phone number This field will be deprecated soon, use the customer object instead")
    phone_country_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The country code for the customer phone number This field will be deprecated soon, use the customer object instead")
    ...
    description: Optional[StrictStr] = Field(default=None, description="An arbitrary string attached to the payment. Often useful for displaying to users or for your own internal record-keeping.")
    return_url: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(default=None, description="The URL to redirect the customer to after they complete the payment process or authentication. This is crucial for flows that involve off-site redirection (e.g., 3DS, some bank redirects, wallet payments).")
    ...
    card_cvc: Optional[StrictStr] = Field(default=None, description="This is used along with the payment_token field while collecting during saved card payments. This field will be deprecated soon, use the payment_method_data.card_token object instead")
    ...
    mandate_id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="A unique identifier to link the payment to a mandate. To do Recurring payments after a mandate has been created, pass the mandate_id instead of payment_method_data")
    ...
    business_sub_label: Optional[StrictStr] = Field(default=None, description="Business sub label for the payment")
    ...
    merchant_order_reference_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Your unique identifier for this payment or order. This ID helps you reconcile payments on your system. If provided, it is passed to the connector if supported.")
    ...
    is_iframe_redirection_enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the redirection has to open in the iframe")
    all_keys_required: Optional[StrictBool] = Field(default=None, description="If enabled, provides whole connector response")
    payment_channel: Optional[PaymentChannel] = None
    tax_status: Optional[TaxStatus] = None
    discount_amount: Optional[StrictInt] = Field(default=None, description="Total amount of the discount you have applied to the order or transaction.")
    shipping_amount_tax: Optional[StrictInt] = Field(default=None, description="This Unit struct represents MinorUnit in which core amount works")
    duty_amount: Optional[StrictInt] = Field(default=None, description="This Unit struct represents MinorUnit in which core amount works")
    order_date: Optional[datetime] = Field(default=None, description="Date the payer placed the order.")
    enable_partial_authorization: Optional[StrictBool] = Field(default=None, description="Allow partial authorization for this payment")
    __properties: ClassVar[List[str]] = ["amount", "order_tax_amount", "currency", "amount_to_capture", "shipping_cost", "payment_id", "merchant_id", "routing", "connector", "capture_method", "authentication_type", "billing", "capture_on", "confirm", "customer", "customer_id", "email", "name", "phone", "phone_country_code", "off_session", "description", "return_url", "setup_future_usage", "payment_method_data", "payment_method", "payment_token", "card_cvc", "shipping", "statement_descriptor_name", "statement_descriptor_suffix", "order_details", "client_secret", "mandate_data", "customer_acceptance", "mandate_id", "browser_info", "payment_experience", "payment_method_type", "business_country", "business_label", "merchant_connector_details", "allowed_payment_method_types", "business_sub_label", "retry_action", "metadata", "connector_metadata", "feature_metadata", "payment_link", "payment_link_config", "payment_link_config_id", "profile_id", "surcharge_details", "payment_type", "request_incremental_authorization", "session_expiry", "frm_metadata", "request_external_three_ds_authentication", "recurring_details", "split_payments", "request_extended_authorization", "merchant_order_reference_id", "skip_external_tax_calculation", "psd2_sca_exemption_type", "ctp_service_details", "force_3ds_challenge", "threeds_method_comp_ind", "is_iframe_redirection_enabled", "all_keys_required", "payment_channel", "tax_status", "discount_amount", "shipping_amount_tax", "duty_amount", "order_date", "enable_partial_authorization"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of payment_channel
        if self.payment_channel:
            _dict['payment_channel'] = self.payment_channel.to_dict()
        ...
        # set to None if is_iframe_redirection_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.is_iframe_redirection_enabled is None and "is_iframe_redirection_enabled" in self.model_fields_set:
            _dict['is_iframe_redirection_enabled'] = None

        # set to None if all_keys_required (nullable) is None
        # and model_fields_set contains the field
        if self.all_keys_required is None and "all_keys_required" in self.model_fields_set:
            _dict['all_keys_required'] = None

        # set to None if payment_channel (nullable) is None
        # and model_fields_set contains the field
        if self.payment_channel is None and "payment_channel" in self.model_fields_set:
            _dict['payment_channel'] = None

        # set to None if tax_status (nullable) is None
        # and model_fields_set contains the field
        if self.tax_status is None and "tax_status" in self.model_fields_set:
            _dict['tax_status'] = None
        ...
        # set to None if shipping_amount_tax (nullable) is None
        # and model_fields_set contains the field
        if self.shipping_amount_tax is None and "shipping_amount_tax" in self.model_fields_set:
            _dict['shipping_amount_tax'] = None

        # set to None if duty_amount (nullable) is None
        # and model_fields_set contains the field
        if self.duty_amount is None and "duty_amount" in self.model_fields_set:
            _dict['duty_amount'] = None
        ...
        # set to None if enable_partial_authorization (nullable) is None
        # and model_fields_set contains the field
        if self.enable_partial_authorization is None and "enable_partial_authorization" in self.model_fields_set:
            _dict['enable_partial_authorization'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_iframe_redirection_enabled": obj.get("is_iframe_redirection_enabled"),
            "all_keys_required": obj.get("all_keys_required"),
            "payment_channel": PaymentChannel.from_dict(obj["payment_channel"]) if obj.get("payment_channel") is not None else None,
            "tax_status": obj.get("tax_status"),
            "discount_amount": obj.get("discount_amount"),
            "shipping_amount_tax": obj.get("shipping_amount_tax"),
            "duty_amount": obj.get("duty_amount"),
            "order_date": obj.get("order_date"),
            "enable_partial_authorization": obj.get("enable_partial_authorization")
        })
        return _obj
