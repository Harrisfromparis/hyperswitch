...
class WalletData(BaseModel):
    ...
    # data type: WalletDataOneOf29
    oneof_schema_30_validator: Optional[WalletDataOneOf29] = None
    # data type: WalletDataOneOf30
    oneof_schema_31_validator: Optional[WalletDataOneOf30] = None
    # data type: WalletDataOneOf31
    oneof_schema_32_validator: Optional[WalletDataOneOf31] = None
    # data type: WalletDataOneOf32
    oneof_schema_33_validator: Optional[WalletDataOneOf32] = None
    # data type: WalletDataOneOf33
    oneof_schema_34_validator: Optional[WalletDataOneOf33] = None
    actual_instance: Optional[Union[WalletDataOneOf, WalletDataOneOf1, WalletDataOneOf10, WalletDataOneOf11, WalletDataOneOf12, WalletDataOneOf13, WalletDataOneOf14, WalletDataOneOf15, WalletDataOneOf16, WalletDataOneOf17, WalletDataOneOf18, WalletDataOneOf19, WalletDataOneOf2, WalletDataOneOf20, WalletDataOneOf21, WalletDataOneOf22, WalletDataOneOf23, WalletDataOneOf24, WalletDataOneOf25, WalletDataOneOf26, WalletDataOneOf27, WalletDataOneOf28, WalletDataOneOf29, WalletDataOneOf3, WalletDataOneOf30, WalletDataOneOf31, WalletDataOneOf32, WalletDataOneOf33, WalletDataOneOf4, WalletDataOneOf5, WalletDataOneOf6, WalletDataOneOf7, WalletDataOneOf8, WalletDataOneOf9]] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, WalletDataOneOf28):
            ...
            match += 1
        # validate data type: WalletDataOneOf29
        if not isinstance(v, WalletDataOneOf29):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WalletDataOneOf29`")
        else:
            match += 1
        # validate data type: WalletDataOneOf30
        if not isinstance(v, WalletDataOneOf30):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WalletDataOneOf30`")
        else:
            match += 1
        # validate data type: WalletDataOneOf31
        if not isinstance(v, WalletDataOneOf31):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WalletDataOneOf31`")
        else:
            match += 1
        # validate data type: WalletDataOneOf32
        if not isinstance(v, WalletDataOneOf32):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WalletDataOneOf32`")
        else:
            match += 1
        # validate data type: WalletDataOneOf33
        if not isinstance(v, WalletDataOneOf33):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WalletDataOneOf33`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in WalletData with oneOf schemas: WalletDataOneOf, WalletDataOneOf1, WalletDataOneOf10, WalletDataOneOf11, WalletDataOneOf12, WalletDataOneOf13, WalletDataOneOf14, WalletDataOneOf15, WalletDataOneOf16, WalletDataOneOf17, WalletDataOneOf18, WalletDataOneOf19, WalletDataOneOf2, WalletDataOneOf20, WalletDataOneOf21, WalletDataOneOf22, WalletDataOneOf23, WalletDataOneOf24, WalletDataOneOf25, WalletDataOneOf26, WalletDataOneOf27, WalletDataOneOf28, WalletDataOneOf29, WalletDataOneOf3, WalletDataOneOf30, WalletDataOneOf31, WalletDataOneOf32, WalletDataOneOf33, WalletDataOneOf4, WalletDataOneOf5, WalletDataOneOf6, WalletDataOneOf7, WalletDataOneOf8, WalletDataOneOf9. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into WalletDataOneOf29
        try:
            instance.actual_instance = WalletDataOneOf29.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into WalletDataOneOf30
        try:
            instance.actual_instance = WalletDataOneOf30.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into WalletDataOneOf31
        try:
            instance.actual_instance = WalletDataOneOf31.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into WalletDataOneOf32
        try:
            instance.actual_instance = WalletDataOneOf32.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into WalletDataOneOf33
        try:
            instance.actual_instance = WalletDataOneOf33.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
