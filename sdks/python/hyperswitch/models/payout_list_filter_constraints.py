...
class PayoutListFilterConstraints(BaseModel):
    ...
    merchant_order_reference_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The merchant order reference ID for payout")
    ...
    __properties: ClassVar[List[str]] = ["start_time", "end_time", "payout_id", "merchant_order_reference_id", "profile_id", "customer_id", "limit", "offset", "connector", "currency", "status", "payout_method", "entity_type"]
