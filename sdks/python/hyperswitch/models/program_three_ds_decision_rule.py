...
class ProgramThreeDsDecisionRule(BaseModel):
    """
    ProgramThreeDsDecisionRule
    """ # noqa: E501
    default_selection: ThreeDSDecisionRule = Field(alias="defaultSelection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultSelection": ThreeDSDecisionRule.from_dict(obj["defaultSelection"]) if obj.get("defaultSelection") is not None else None,
            "rules": RuleThreeDsDecisionRule.from_dict(obj["rules"]) if obj.get("rules") is not None else None,
