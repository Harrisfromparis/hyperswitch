...
class BusinessPaymentLinkConfig(BaseModel):
    """
    ...
    is_setup_mandate_flow: Optional[StrictBool] = Field(default=None, description="Boolean to control payment button text for setup mandate calls")
    color_icon_card_cvc_error: Optional[StrictStr] = Field(default=None, description="Hex color for the CVC icon during error state")
    domain_name: Optional[StrictStr] = Field(default=None, description="Custom domain name to be used for hosting the link in your own domain")
    business_specific_configs: Optional[Dict[str, PaymentLinkConfigRequest]] = Field(default=None, description="list of configs for multi theme setup")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in business_specific_configs (dict)
        _field_dict = {}
        if self.business_specific_configs:
            for _key_business_specific_configs in self.business_specific_configs:
                if self.business_specific_configs[_key_business_specific_configs]:
                    _field_dict[_key_business_specific_configs] = self.business_specific_configs[_key_business_specific_configs].to_dict()
            _dict['business_specific_configs'] = _field_dict
        ...
        # set to None if is_setup_mandate_flow (nullable) is None
        # and model_fields_set contains the field
        if self.is_setup_mandate_flow is None and "is_setup_mandate_flow" in self.model_fields_set:
            _dict['is_setup_mandate_flow'] = None

        # set to None if color_icon_card_cvc_error (nullable) is None
        # and model_fields_set contains the field
        if self.color_icon_card_cvc_error is None and "color_icon_card_cvc_error" in self.model_fields_set:
            _dict['color_icon_card_cvc_error'] = None
        ...
        # set to None if business_specific_configs (nullable) is None
        # and model_fields_set contains the field
        if self.business_specific_configs is None and "business_specific_configs" in self.model_fields_set:
            _dict['business_specific_configs'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_setup_mandate_flow": obj.get("is_setup_mandate_flow"),
            "color_icon_card_cvc_error": obj.get("color_icon_card_cvc_error"),
            "domain_name": obj.get("domain_name"),
            "business_specific_configs": dict(
                (_k, PaymentLinkConfigRequest.from_dict(_v))
                for _k, _v in obj["business_specific_configs"].items()
            )
            if obj.get("business_specific_configs") is not None
            else None,
