...
class RequestPaymentMethodTypes(BaseModel):
    ...
    recurring_enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether the payment method supports recurring payments. Optional.")
    installment_payment_enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether the payment method is eligible for installment payments (e.g., EMI, BNPL). Optional.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if recurring_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.recurring_enabled is None and "recurring_enabled" in self.model_fields_set:
            _dict['recurring_enabled'] = None

        # set to None if installment_payment_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.installment_payment_enabled is None and "installment_payment_enabled" in self.model_fields_set:
            _dict['installment_payment_enabled'] = None
