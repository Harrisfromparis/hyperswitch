...
class RuleThreeDsDecisionRule(BaseModel):
    """
    RuleThreeDsDecisionRule
    """ # noqa: E501
    name: StrictStr
    connector_selection: ThreeDSDecision = Field(alias="connectorSelection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "connectorSelection": obj.get("connectorSelection"),
