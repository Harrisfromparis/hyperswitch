...
class PaymentAttemptResponse(BaseModel):
    ...
    """ # noqa: E501
    attempt_id: StrictStr = Field(description="A unique identifier for this specific payment attempt.")
    ...
    connector: Optional[StrictStr] = Field(default=None, description="The name of the payment connector (e.g., 'stripe', 'adyen') used for this attempt.")
    error_message: Optional[StrictStr] = Field(default=None, description="A human-readable message from the connector explaining the error, if one occurred during this payment attempt.")
    ...
    mandate_id: Optional[StrictStr] = Field(default=None, description="If this payment attempt is associated with a mandate (e.g., for a recurring or subsequent payment), this field will contain the ID of that mandate.")
    error_code: Optional[StrictStr] = Field(default=None, description="The error code returned by the connector if this payment attempt failed. This code is specific to the connector.")
    payment_token: Optional[StrictStr] = Field(default=None, description="If a tokenized (saved) payment method was used for this attempt, this field contains the payment token representing that payment method.")
    ...
    reference_id: Optional[StrictStr] = Field(default=None, description="The connector's own reference or transaction ID for this specific payment attempt. Useful for reconciliation with the connector.")
