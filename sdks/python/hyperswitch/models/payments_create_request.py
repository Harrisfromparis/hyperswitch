...
class PaymentsCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    amount: Annotated[int, Field(strict=True, ge=0)] = Field(description="The primary amount for the payment, provided in the lowest denomination of the specified currency (e.g., 6540 for $65.40 USD). This field is mandatory for creating a payment.")
