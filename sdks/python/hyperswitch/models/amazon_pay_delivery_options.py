...
class AmazonPayDeliveryOptions(BaseModel):
    """
    AmazonPayDeliveryOptions
    """ # noqa: E501
    id: StrictStr = Field(description="Delivery Option identifier")
    price: AmazonPayDeliveryPrice
    shipping_method: AmazonPayShippingMethod
    is_default: StrictBool = Field(description="Specifies if this delivery option is the default")
    __properties: ClassVar[List[str]] = ["id", "price", "shipping_method", "is_default"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "price": AmazonPayDeliveryPrice.from_dict(obj["price"]) if obj.get("price") is not None else None,
            "shipping_method": AmazonPayShippingMethod.from_dict(obj["shipping_method"]) if obj.get("shipping_method") is not None else None,
