...
class GsmCreateRequest(BaseModel):
    """
    GsmCreateRequest
    """ # noqa: E501
    connector: Connector
    ...
    step_up_possible: StrictBool = Field(description="indicates if step_up retry is possible **Deprecated**: This field is now included as part of `feature_data` under the `Retry` variant.")
    ...
    clear_pan_possible: StrictBool = Field(description="indicates if retry with pan is possible **Deprecated**: This field is now included as part of `feature_data` under the `Retry` variant.")
