...
class RoutingConfigRequest(BaseModel):
    ...
    algorithm: Optional[StaticRoutingAlgorithm] = None
    profile_id: Optional[StrictStr] = None
    transaction_type: Optional[TransactionType] = None
    __properties: ClassVar[List[str]] = ["name", "description", "algorithm", "profile_id", "transaction_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "algorithm": StaticRoutingAlgorithm.from_dict(obj["algorithm"]) if obj.get("algorithm") is not None else None,
