...
class GpayEcryptedTokenizationData(BaseModel):
    """
    This struct represents the encrypted Gpay payment data
    """ # noqa: E501
    type: StrictStr = Field(description="The type of the token")
    token: StrictStr = Field(description="Token generated for the wallet")
