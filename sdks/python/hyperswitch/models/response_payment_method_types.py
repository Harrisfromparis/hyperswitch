...
class ResponsePaymentMethodTypes(BaseModel):
    ...
    bank_names: Optional[List[BankCodeResponse]] = Field(default=None, description="The list of banks enabled, if applicable for a payment method type . To be deprecated soon.")
