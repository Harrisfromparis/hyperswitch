...
class OrderDetailsWithAmount(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description for the item")
    sku: Optional[StrictStr] = Field(default=None, description="Stock Keeping Unit (SKU) or the item identifier for this item.")
    upc: Optional[StrictStr] = Field(default=None, description="Universal Product Code for the item.")
    commodity_code: Optional[StrictStr] = Field(default=None, description="Code describing a commodity or a group of commodities pertaining to goods classification.")
    unit_of_measure: Optional[StrictStr] = Field(default=None, description="Unit of measure used for the item quantity.")
    total_amount: Optional[StrictInt] = Field(default=None, description="Total amount for the item.")
    unit_discount_amount: Optional[StrictInt] = Field(default=None, description="Discount amount applied to this item.")
    __properties: ClassVar[List[str]] = ["product_name", "quantity", "amount", "tax_rate", "total_tax_amount", "requires_shipping", "product_img_link", "product_id", "category", "sub_category", "brand", "product_type", "product_tax_code", "description", "sku", "upc", "commodity_code", "unit_of_measure", "total_amount", "unit_discount_amount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if commodity_code (nullable) is None
        # and model_fields_set contains the field
        if self.commodity_code is None and "commodity_code" in self.model_fields_set:
            _dict['commodity_code'] = None
        ...
        # set to None if unit_discount_amount (nullable) is None
        # and model_fields_set contains the field
        if self.unit_discount_amount is None and "unit_discount_amount" in self.model_fields_set:
            _dict['unit_discount_amount'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sku": obj.get("sku"),
            "upc": obj.get("upc"),
            "commodity_code": obj.get("commodity_code"),
            "unit_of_measure": obj.get("unit_of_measure"),
            "total_amount": obj.get("total_amount"),
            "unit_discount_amount": obj.get("unit_discount_amount")
        })
        return _obj
