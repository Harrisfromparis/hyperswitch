...
class MerchantAccountResponse(BaseModel):
    ...
    frm_routing_algorithm: Optional[StaticRoutingAlgorithm] = None
    ...
    __properties: ClassVar[List[str]] = ["merchant_id", "merchant_name", "return_url", "enable_payment_response_hash", "payment_response_hash_key", "redirect_to_merchant_with_http_post", "merchant_details", "webhook_details", "payout_routing_algorithm", "sub_merchants_enabled", "parent_merchant_id", "publishable_key", "metadata", "locker_id", "primary_business_details", "frm_routing_algorithm", "organization_id", "is_recon_enabled", "default_profile", "recon_status", "pm_collect_link_config", "product_type", "merchant_account_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frm_routing_algorithm": StaticRoutingAlgorithm.from_dict(obj["frm_routing_algorithm"]) if obj.get("frm_routing_algorithm") is not None else None,
