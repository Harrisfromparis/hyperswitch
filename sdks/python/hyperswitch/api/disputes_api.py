...
class DisputesApi:
    ...
    def retrieve_a_dispute(
        ...
        force_sync: Annotated[Optional[StrictBool], Field(description="Decider to enable or disable the connector call for dispute retrieve request")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type dispute_id: str
        :param force_sync: Decider to enable or disable the connector call for dispute retrieve request
