...
class RefundsApi:
    ...
    def create_a_refund(
        ...
        _param = self._create_a_refund_serialize(
    ...
    @validate_call
    def create_a_refund_with_http_info(
        self,
        refund_request: RefundRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_a_refund_without_preload_content(
        self,
        refund_request: RefundRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_a_refund_serialize(
        self,
        refund_request,
        _request_auth,
        _content_type,
    ...
    def list_all_refunds(
        self,
        refund_list_request: RefundListRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param refund_list_request: (required)
        :type refund_list_request: RefundListRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._list_all_refunds_serialize(
            refund_list_request=refund_list_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_all_refunds_with_http_info(
        self,
        refund_list_request: RefundListRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_all_refunds_without_preload_content(
        self,
        refund_list_request: RefundListRequest,
        _request_timeout: Union[
            None,
    ...
    def _list_all_refunds_serialize(
        self,
        refund_list_request,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if refund_list_request is not None:
            _body_params = refund_list_request
    ...
    def retrieve_a_refund(
        self,
        refund_id: Annotated[StrictStr, Field(description="The identifier for refund")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param refund_id: The identifier for refund (required)
        :type refund_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._retrieve_a_refund_serialize(
            refund_id=refund_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def retrieve_a_refund_with_http_info(
        self,
        refund_id: Annotated[StrictStr, Field(description="The identifier for refund")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retrieve_a_refund_without_preload_content(
        self,
        refund_id: Annotated[StrictStr, Field(description="The identifier for refund")],
        _request_timeout: Union[
            None,
    ...
    def _retrieve_a_refund_serialize(
        self,
        refund_id,
        _request_auth,
        _content_type,
    ...
    def update_a_refund(
        ...
        :param refund_id: The identifier for refund (required)
        :type refund_id: str
        :param refund_update_request: (required)
        :type refund_update_request: RefundUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_a_refund_serialize(
            refund_id=refund_id,
            refund_update_request=refund_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_a_refund_with_http_info(
        self,
        refund_id: Annotated[StrictStr, Field(description="The identifier for refund")],
        refund_update_request: RefundUpdateRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def update_a_refund_without_preload_content(
        self,
        refund_id: Annotated[StrictStr, Field(description="The identifier for refund")],
        refund_update_request: RefundUpdateRequest,
        _request_timeout: Union[
    ...
    def _update_a_refund_serialize(
        self,
        refund_id,
        ...
        # process the form parameters
        # process the body parameter
        if refund_update_request is not None:
            _body_params = refund_update_request
