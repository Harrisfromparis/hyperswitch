...
class TestPayoutCreateResponse1(unittest.TestCase):
    """PayoutCreateResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutCreateResponse1:
        """Test PayoutCreateResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutCreateResponse1`
        """
        model = PayoutCreateResponse1()
        if include_optional:
            return PayoutCreateResponse1(
                type = 'payout_details',
    ...
    def testPayoutCreateResponse1(self):
        """Test PayoutCreateResponse1"""
