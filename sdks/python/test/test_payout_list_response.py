...
class TestPayoutListResponse(unittest.TestCase):
    """PayoutListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutListResponse:
        """Test PayoutListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutListResponse`
        """
        ...
        if include_optional:
            return PayoutListResponse(
                size = 0,
                data = [
                    hyperswitch.models.payout_create_response.PayoutCreateResponse(
    ...
    def testPayoutListResponse(self):
        """Test PayoutListResponse"""
