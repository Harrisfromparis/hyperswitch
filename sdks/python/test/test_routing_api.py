...
class TestRoutingApi(unittest.TestCase):
    ...
    def test_evaluate_routing_rules(self) -> None:
        """Test case for evaluate_routing_rules

        Routing - Evaluate
        """
        pass

    def test_evaluate_routing_rules__alternative(self) -> None:
        """Test case for evaluate_routing_rules__alternative
    ...
    def test_update_gateway_scores(self) -> None:
        """Test case for update_gateway_scores
