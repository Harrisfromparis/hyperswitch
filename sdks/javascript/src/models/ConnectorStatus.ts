...
export function instanceOfConnectorStatus(value: any): boolean {
    for (const key in ConnectorStatus) {
        if (Object.prototype.hasOwnProperty.call(ConnectorStatus, key)) {
            if (ConnectorStatus[key as keyof typeof ConnectorStatus] === value) {
                return true;
            }
        }
    }
...
export function ConnectorStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): ConnectorStatus {
