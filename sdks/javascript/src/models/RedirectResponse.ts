...
export function RedirectResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RedirectResponse {
    ...
    return {
        ...
        'jsonPayload': json['json_payload'] == null ? undefined : json['json_payload'],
    };
}

export function RedirectResponseToJSON(json: any): RedirectResponse {
    return RedirectResponseToJSONTyped(json, false);
}

export function RedirectResponseToJSONTyped(value?: RedirectResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
